...
const MATRIX: &[MatrixRow] = &[
    ...
    MatrixRow {
        ...
        safe_fixture: None,
        scan_vulnerable: Cell::Covered,
        scan_safe: Cell::Deferred("missing tests/fixtures/safe.php"),
        diff: Cell::Deferred("diff needs a safe PHP baseline fixture"),
        secrets: Cell::Covered,
        terminal: Cell::Covered,
        json: Cell::Covered,
        sarif: Cell::Covered,
    ...
    MatrixRow {
        ...
        safe_fixture: None,
        scan_vulnerable: Cell::Covered,
        scan_safe: Cell::Deferred("missing tests/fixtures/safe.rs"),
        diff: Cell::Deferred("diff needs a safe Rust baseline fixture"),
        secrets: Cell::Covered,
        terminal: Cell::Covered,
        json: Cell::Covered,
        sarif: Cell::Covered,
    ...
    MatrixRow {
        ...
        safe_fixture: None,
        scan_vulnerable: Cell::Covered,
        scan_safe: Cell::Deferred("missing tests/fixtures/safe.cs"),
        diff: Cell::Deferred("diff needs a safe C# baseline fixture"),
        secrets: Cell::Covered,
        terminal: Cell::Covered,
        json: Cell::Covered,
        sarif: Cell::Covered,
    ...
    MatrixRow {
        ...
        safe_fixture: None,
        scan_vulnerable: Cell::Covered,
        scan_safe: Cell::Deferred("missing tests/fixtures/safe.swift"),
        diff: Cell::Deferred("diff needs a safe Swift baseline fixture"),
        secrets: Cell::Covered,
        terminal: Cell::Covered,
        json: Cell::Covered,
        sarif: Cell::Covered,
    ...
    MatrixRow {
        ...
        safe_fixture: None,
        scan_vulnerable: Cell::Deferred("missing top-level Kotlin vulnerable fixture"),
        scan_safe: Cell::Deferred("missing top-level Kotlin safe fixture"),
        diff: Cell::Deferred("diff needs Kotlin safe and vulnerable fixtures"),
        secrets: Cell::Covered,
        terminal: Cell::Deferred("terminal smoke needs a Kotlin vulnerable fixture"),
        json: Cell::Deferred("JSON smoke needs a Kotlin vulnerable fixture"),
        sarif: Cell::Deferred("SARIF smoke needs a Kotlin vulnerable fixture"),
        cbom: Cell::Deferred("CBOM smoke needs a Kotlin vulnerable fixture"),
        pqc: Cell::NotApplicable("no Kotlin PQ rule is registered"),
        taint_explain: Cell::Deferred(
            "top-level Kotlin taint fixture is missing; Kotlin taint coverage exists in unit tests",
        ),
    },
    MatrixRow {
        language: "C",
...
fn taint_explain_matrix_cells_render_traces() {
    ...
    assert!(
        MATRIX
            ...
            .is_some_and(|row| matches!(row.taint_explain, Cell::Deferred(_))),
        "Kotlin taint explain should remain deferred until a top-level fixture exists"
    );
}
