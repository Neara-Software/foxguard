...
const jsRules: Rule[] = [
  ...
  { id: 'js/no-unsafe-deserialization', cwe: 'CWE-502', desc: 'Unsafe deserialization of untrusted data', severity: 'critical' },
  ...
  { id: 'js/taint-log-injection', cwe: 'CWE-117', desc: 'Untrusted input reaches a logging sink — possible log injection', severity: 'medium' },
  { id: 'js/taint-nosql-injection', cwe: 'CWE-943', desc: 'Untrusted input reaches a MongoDB query sink — possible NoSQL injection', severity: 'high' },
...
const pyRules: Rule[] = [
  ...
  { id: 'py/taint-ldap-injection', cwe: 'CWE-90', desc: 'Untrusted input reaches LDAP search sink', severity: 'high' },
  { id: 'py/taint-log-injection', cwe: 'CWE-117', desc: 'Untrusted input reaches a logging sink — possible log injection', severity: 'medium' },
  { id: 'py/taint-nosql-injection', cwe: 'CWE-943', desc: 'Untrusted input reaches a MongoDB query sink — possible NoSQL injection', severity: 'high' },
...
const goRules: Rule[] = [
  ...
  { id: 'go/taint-nosql-injection', cwe: 'CWE-943', desc: 'Untrusted input reaches a MongoDB query sink — possible NoSQL injection', severity: 'high' },
...
const manifestRules: Rule[] = [
  ...
  { id: 'manifest/poetry-pq-vulnerable-dep', cwe: 'CWE-327', desc: 'Dependency uses quantum-vulnerable cryptographic algorithm', severity: 'high' },
];
