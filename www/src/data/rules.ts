...
const jsRules: Rule[] = [
  ...
  { id: 'js/taint-nosql-injection', cwe: 'CWE-943', desc: 'Untrusted input reaches a MongoDB query sink — possible NoSQL injection', severity: 'critical' },
...
const pyRules: Rule[] = [
  ...
  { id: 'py/taint-nosql-injection', cwe: 'CWE-943', desc: 'Untrusted input reaches a MongoDB query sink — possible NoSQL injection', severity: 'critical' },
