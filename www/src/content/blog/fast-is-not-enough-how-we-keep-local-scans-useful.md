...
*foxguard is an open-source security scanner written in Rust. 170+ built-in rules, 10 languages, sub-second local scans, and a focused Semgrep/OpenGrep-compatible YAML bridge. [Try it](https://github.com/0sec-labs/foxguard): `npx foxguard .`*
