...
The first attempt at CNSA 2.0 annotations (PR [#231](https://github.com/0sec-labs/foxguard/pull/231)) did the obvious thing. There were a few deadline year strings in a module, and a function that decided which deadline applied to a finding by looking at the rule ID:
...
Three structural changes, all visible in [`src/compliance.rs`](https://github.com/0sec-labs/foxguard/blob/main/src/compliance.rs).
