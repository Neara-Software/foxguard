...
*foxguard is an open-source security scanner written in Rust. 196 built-in rules, 10 languages, sub-second scans. [Try it](https://github.com/0sec-labs/foxguard): `npx foxguard .`*
