...
*foxguard is an open-source security scanner written in Rust. 200+ built-in rules, 12 source languages, cross-file taint tracking for Python, JavaScript, and Go. [Try it](https://github.com/0sec-labs/foxguard): `npx foxguard .`*
