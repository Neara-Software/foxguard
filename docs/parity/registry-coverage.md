...
| Total rules | 2145 |
| Rules loaded OK | 2089 (97.4%) |
| Rules skipped | 56 (2.6%) |

**Headline load rate: 97.4%** (2089 / 2145 rules).
...
|---|---:|---:|---:|
| `mode: taint (unsupported shape)` | 55 | 98.2% | 2.6% |
| `generic mode (languages: [generic])` | 1 | 1.8% | 0.0% |
...
|---:|---|---:|
| 1 | `mode: taint (unsupported shape)` | 55 |

Operator/feature gaps account for **55 rules** (2.6% of all rules). Closing the top of this list is the highest-leverage parity work that does not require a new parser.
...
- **php**: `mode: taint (unsupported shape)` (6)
- **python**: `mode: taint (unsupported shape)` (11)
