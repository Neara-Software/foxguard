...
| Total rules | 2144 |
| Rules loaded OK | 1972 (92.0%) |
| Rules skipped | 172 (8.0%) |

**Headline load rate: 92.0%** (1972 / 2144 rules).
...
|---|---:|---:|---:|
| `mode: taint (unsupported shape)` | 125 | 72.7% | 5.8% |
| `unsupported language: apex` | 9 | 5.2% | 0.4% |
| `generic mode (languages: [generic])` | 7 | 4.1% | 0.3% |
| `mode: taint (unsupported language: scala)` | 5 | 2.9% | 0.2% |
| `taint: pattern-propagators` | 5 | 2.9% | 0.2% |
| `unsupported language: clojure` | 5 | 2.9% | 0.2% |
| `unsupported language: html` | 4 | 2.3% | 0.2% |
...
|---:|---|---:|
| 1 | `mode: taint (unsupported shape)` | 125 |
| 2 | `taint: pattern-propagators` | 5 |

Operator/feature gaps account for **130 rules** (6.1% of all rules). Closing the top of this list is the highest-leverage parity work that does not require a new parser.
