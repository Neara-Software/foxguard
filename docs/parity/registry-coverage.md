...
> Status: 2026-06-19. Generated by `cargo run --release --bin registry_coverage -- /Users/peak/coding/0sec-labs/foxguard/.registry-snapshot`.
...
| Total rules | 2144 |
| Rules loaded OK | 2062 (96.2%) |
| Rules skipped | 82 (3.8%) |

**Headline load rate: 96.2%** (2062 / 2144 rules).
...
|---|---:|---:|---:|
| `mode: taint (unsupported shape)` | 73 | 89.0% | 3.4% |
| `generic mode (languages: [generic])` | 5 | 6.1% | 0.2% |
| `taint: pattern-propagators` | 4 | 4.9% | 0.2% |
...
|---:|---|---:|
| 1 | `mode: taint (unsupported shape)` | 73 |
| 2 | `taint: pattern-propagators` | 4 |

Operator/feature gaps account for **77 rules** (3.6% of all rules). Closing the top of this list is the highest-leverage parity work that does not require a new parser.
...
Missing-grammar gaps account for **5 rules** (0.2% of all rules).
