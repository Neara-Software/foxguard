...
> Status: 2026-07-04. Generated by `cargo run --release --bin registry_coverage -- /Users/peak/coding/0sec-labs/foxguard/.registry-snapshot`.
...
| Total rules | 2144 |
| Rules loaded OK | 2083 (97.2%) |
| Rules skipped | 61 (2.8%) |

**Headline load rate: 97.2%** (2083 / 2144 rules).
...
|---|---:|---:|---:|
| `mode: taint (unsupported shape)` | 60 | 98.4% | 2.8% |
| `generic mode (languages: [generic])` | 1 | 1.6% | 0.0% |
...
|---:|---|---:|
| 1 | `mode: taint (unsupported shape)` | 60 |

Operator/feature gaps account for **60 rules** (2.8% of all rules). Closing the top of this list is the highest-leverage parity work that does not require a new parser.
