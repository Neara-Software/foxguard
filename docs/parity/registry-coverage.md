...
| Total rules | 2144 |
| Rules loaded OK | 2097 (97.8%) |
| Rules skipped | 47 (2.2%) |

**Headline load rate: 97.8%** (2097 / 2144 rules).
...
|---|---:|---:|---:|
| `mode: taint (unsupported shape)` | 46 | 97.9% | 2.1% |
...
|---:|---|---:|
| 1 | `mode: taint (unsupported shape)` | 46 |

Operator/feature gaps account for **46 rules** (2.1% of all rules). Closing the top of this list is the highest-leverage parity work that does not require a new parser.
