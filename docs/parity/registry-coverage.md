...
| Total rules | 2144 |
| Rules loaded OK | 2094 (97.7%) |
| Rules skipped | 50 (2.3%) |

**Headline load rate: 97.7%** (2094 / 2144 rules).
...
|---|---:|---:|---:|
| `mode: taint (unsupported shape)` | 49 | 98.0% | 2.3% |
...
|---:|---|---:|
| 1 | `mode: taint (unsupported shape)` | 49 |

Operator/feature gaps account for **49 rules** (2.3% of all rules). Closing the top of this list is the highest-leverage parity work that does not require a new parser.
...
- **csharp**: `mode: taint (unsupported shape)` (5)
