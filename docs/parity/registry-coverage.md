...
| Total rules | 2144 |
| Rules loaded OK | 2086 (97.3%) |
| Rules skipped | 58 (2.7%) |

**Headline load rate: 97.3%** (2086 / 2144 rules).
...
|---|---:|---:|---:|
| `mode: taint (unsupported shape)` | 57 | 98.3% | 2.7% |
...
|---:|---|---:|
| 1 | `mode: taint (unsupported shape)` | 57 |

Operator/feature gaps account for **57 rules** (2.7% of all rules). Closing the top of this list is the highest-leverage parity work that does not require a new parser.
...
- **python**: `mode: taint (unsupported shape)` (12)
